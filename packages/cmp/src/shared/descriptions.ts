...
const CATEGORY_DESCRIPTIONS: Record<
  CategoryId,
  Record<DescriptionPreset, CategoryDescription>
> = {
  essential: {
    default: {
...
const COMMON_COOKIES: Record<string, CommonCookieInfo> = {
  // Google Analytics
  _ga: { category: "analytics", provider: "Google Analytics", duration: "2 years", purpose: "Distinguishes unique users by assigning a randomly generated number as a client identifier" },
  _gid: { category: "analytics", provider: "Google Analytics", duration: "24 hours", purpose: "Distinguishes unique users, stores and updates a unique value for each page visited" },
  _gat: { category: "analytics", provider: "Google Analytics", duration: "1 minute", purpose: "Used to throttle request rate to Google Analytics" },
  // Facebook
  _fbp: { category: "marketing", provider: "Facebook", duration: "3 months", purpose: "Tracks visits across websites to deliver targeted advertising" },
  fr: { category: "marketing", provider: "Facebook", duration: "3 months", purpose: "Delivers, measures, and improves the relevancy of ads" },
  // Google Ads
  _gcl_au: { category: "marketing", provider: "Google Ads", duration: "3 months", purpose: "Stores conversion data for Google Ads campaigns" },
  IDE: { category: "marketing", provider: "Google DoubleClick", duration: "1 year", purpose: "Used by Google DoubleClick to serve targeted advertisements" },
  // LinkedIn
  li_sugr: { category: "marketing", provider: "LinkedIn", duration: "3 months", purpose: "Used for LinkedIn ad targeting and analytics" },
  bcookie: { category: "social-media", provider: "LinkedIn", duration: "1 year", purpose: "Browser identifier cookie for LinkedIn sharing features" },
  // Twitter/X
  guest_id: { category: "social-media", provider: "Twitter/X", duration: "2 years", purpose: "Identifies non-logged-in users for embedded content" },
  // HubSpot
  __hssc: { category: "analytics", provider: "HubSpot", duration: "30 minutes", purpose: "Tracks session data for HubSpot analytics" },
  __hssrc: { category: "analytics", provider: "HubSpot", duration: "Session", purpose: "Determines if the user has restarted their browser" },
  __hstc: { category: "analytics", provider: "HubSpot", duration: "13 months", purpose: "Tracks visitors and contains domain, first visit timestamp, last visit timestamp, current visit timestamp, and session number" },
  // Hotjar
  _hjSessionUser: { category: "analytics", provider: "Hotjar", duration: "1 year", purpose: "Ensures subsequent visits are attributed to the same user ID" },
  _hjSession: { category: "analytics", provider: "Hotjar", duration: "30 minutes", purpose: "Holds current session data" },
  // Microsoft Clarity
  _clck: { category: "analytics", provider: "Microsoft Clarity", duration: "1 year", purpose: "Persists the Clarity User ID and preferences" },
  _clsk: { category: "analytics", provider: "Microsoft Clarity", duration: "1 day", purpose: "Connects multiple page views by a user into a single Clarity session recording" },
  // TikTok
  _ttp: { category: "marketing", provider: "TikTok", duration: "13 months", purpose: "Tracks performance of TikTok advertising campaigns" },
  // Stripe
  __stripe_mid: { category: "essential", provider: "Stripe", duration: "1 year", purpose: "Fraud prevention for payment processing" },
  __stripe_sid: { category: "essential", provider: "Stripe", duration: "Session", purpose: "Fraud prevention for payment processing" },
};
