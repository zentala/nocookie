/**
 * @module shared/descriptions-data
 * Data constants for cookie category descriptions and well-known cookie metadata.
 */

import type { CategoryId } from "./types";
import type { CategoryDescription, DescriptionPreset, CommonCookieInfo } from "./descriptions";
...
export const COMMON_COOKIES: Record<string, CommonCookieInfo> = {
  // Google Analytics
  _ga: {
    category: "analytics",
