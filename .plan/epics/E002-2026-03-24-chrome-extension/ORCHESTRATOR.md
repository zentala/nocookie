...
- [x] **E002-T01** — Project scaffolding and build system
...
- [x] **E002-T02** — Shared types, constants, and category taxonomy
...
- [x] **E002-T03** — Chrome storage wrapper and preference management
...
- [x] **E002-T04** — Background service worker skeleton + message passing
...
- [x] **E002-T05** — Content script skeleton (detector + observer)
...
- [x] **E002-T06** — CMP rule format and rule engine
...
- [x] **E002-T07** — MAIN world executor framework
...
- [x] **E002-T25** — Autoconsent library integration
...
- [x] **E002-T08** — OneTrust verification + custom per-category mapping
...
- [x] **E002-T09** — Cookiebot verification + custom per-category mapping
...
- [x] **E002-T10** — Didomi verification + custom per-category mapping
...
- [x] **E002-T26** — GPC header emission
...
- [x] **E002-T11** — Generic heuristic fallback detector
...
- [x] **E002-T12** — Well-known standard reader
...
- [x] **E002-T31** — Loading/detecting state in popup
...
- [x] **E002-T27** — First-run onboarding flow
...
- [x] **E002-T14** — Options page: Preferences + Profiles
...
- [x] **E002-T15** — Options page: Site Overrides + Advanced + Statistics
...
- [x] **E002-T16** — Badge/icon state management
...
- [x] **E002-T17** — Open standard JSON schema and validator library
...
- [x] **E002-T18** — Additional CMP verification: Quantcast, TrustArc, CookieYes
...
- [x] **E002-T19** — Additional CMP verification: Complianz, Osano, consentmanager
...
- [x] **E002-T28** — Consent dashboard page
...
- [x] **E002-T20** — Website scaffolding (Astro + Cloudflare Pages)
...
- [x] **E002-T21** — Standard specification page
...
- [x] **E002-T29** — Online validator/generator tool
...
- [x] **E002-T22** — Implementation guides + AI agent instructions
...
- [x] **E002-T30** — Accessibility audit and fixes
...
- [x] **E002-T23** — Comprehensive E2E test suite
...
- [x] **E002-T24** — Chrome Web Store preparation and publishing
...
- [x] **E002-T32** — Integrate website articles into site structure
...
- [x] **E002-T33** — Project naming brainstorm and branding
